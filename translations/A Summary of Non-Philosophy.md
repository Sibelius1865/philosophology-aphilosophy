...
**2.1.5.** 〈一者〉は、言語それ自体（in-itself）に対置され、それゆえに哲学的または弁証法的な対立を形成するような、対象／実体（object/entity）「それ自体（in itself）」ではない。〈一者のうちで見えるもの〉 は思考の母体（matrix）であり、「〈一者〉に**一致しながら**（*according to*）、〈一者〉を語る／思考する（speaking/thinking）」ことである。また、それは〈一者〉（〈実在〉）と言語のあいだの綜合の関係でもない。それは非関係（non-relation） であり、「単面的二元性」 なのである。
...
それはもはや、哲学的な装置のような両面性（二面性）や双方向性をもつものではなく、むしろ単面性（一方向性）あるいは片面的（unilateral）な装置である。つまり、二元性でありながら〈同一性〉であり、しかしその〈同一性〉は統合（synthesis）ではない。これこそが「最終的決定（Determination-in-the-last-instance）」の構造そのものである。非-哲学は、システムを構成することなく、単一性を持たずに思考する。例えば、それが生み出される主体（「異邦人（the Stranger）」）は、私の前に対峙するものではなく、それ自体が単一の面（uniface）をなし、そのため世界に対しては異邦人であり、哲学や世界に特有の二面性の法則から逸脱しているが、実在に対しては異邦人ではない。

**4.1.4. 非-哲学的実現の偶然性と必然性**

非-哲学の公理や定理が哲学的な素材から引き出されるという起源、すなわちそれが思考の一形態であるという事実のために、非-哲学は〈一者〉の観点から見ると、実在に対して全面的に偶然的であり、それに対して閉ざされている。しかし、実在によって決定される思考として、それは〈一者のうちで見えるもの〉の実在的必然性を獲得し、またこの実在的偶然性の超越論的必然性をも獲得する。〈一者〉は、哲学をそのままの形で、あるいはそれが自らを与える形で正当化するのではなく、哲学がその「あたえられること（being-given）」のうちで変容する限りにおいてのみ正当化する。哲学の観点からすると、非-哲学は必要なものであるが、部分的にはトートロジー的でもある。〈一者〉に従って思考する（このモードに従って哲学を思考する）ことは、この側面から見れば、哲学的な目的であり、哲学的手段を用いるものである。

**4.1.5. 実在的〈一者〉の閉鎖性**

非一貫性（non-consistency）は、実在が哲学的思考や非-哲学的思考のいずれに対しても閉ざされている（foreclosed）ことを含意するか、またはそれを前提とする。ここでは両者は同義である。しかし、それにもかかわらず、実在はその〈一者のうちで見えるもの〉としての様態に従って思考を与えることができる。したがって、思考は実在に影響を与えることなく、実在はそれを受け取ることなく、ただあたえるだけである。〈一者のうちであたえられること（being-given-in-One）〉には、事前の受容（reception）はない。これは、現象学に対する現象性の根本的自律性、哲学的・経験的な「あたえ-受け取る」モデルや受動性に対する現象の優位性を意味する。〈一者〉の閉鎖性は、哲学が〈一者のうちで見えるもの〉を明示的に実現する場合でも取り消されることはなく、その実現を通じて維持される。この閉鎖性は、実在に対する哲学の因果性を停止させるが、思考そのものに対する哲学の因果性をすべて停止させるわけではない。思考に関しては、哲学は単なる実現の「契機」となるにすぎない。いずれにせよ、この閉鎖性は、〈一者〉が思考や言語、さらには世界全般をあたえることを妨げるものではない。
