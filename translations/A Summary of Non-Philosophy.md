...
**5.1.3.** 「**～にしたがって=一致して**（_according to_）」、あるいはクローンとは、〈一者〉を超過（exceed）しているようであり、それはちょうど超越論的なものが〈実在〉を超過しているように見える。しかし、実際には=実在性においては（in reality）、それは〈一者〉を超過してはいない。それは〈一者-内〉での様態であり、哲学の内部において超越論的なものへと「生成される」ことによって、それ自体を超過するわけではない。むしろ、〈一者〉を超過するのは哲学のほうである（二元性）。しかし、それは外在性（哲学的二項関係（philosophical dyad））において〈一者〉を超過するわけではない。なぜなら、哲学はすでにつねに、〈一者のうちであたえられている〉からである。哲学が〈一者〉を超過するのは、その本来的な実在性を通して、〈内在的に-あたえられていること（immanent-being-given）〉の「うち（within）」で、あるいは〈一者のうちであたえられること〉の「うち」でのみである。クローニングは、**もし**哲学が自己を現前させるならば、あるいはむしろ、**もし**哲学がみずからの一貫性と自律性にしたがって考慮されるならば、それは必然的である。そしてクローニングは、〈実在〉の観点から見れば、可能であるか矛盾しないのである。

**5.1.4.** クローンは、あるあたえられた同一性の複製ではない。なぜなら、それは実際には=実在性においてはすでに二重化されている、あるいはすでに二重項だからである。これは「反対に」、**ひとつの哲学的二重体（の）実在-超越論的だが分割不可能な〈同一性〉**（_the real-transcendental but indivisible Identity (of) a philosophical double_）である。〈実在〉は、それ自体のクローンではなく、根源的に単純な〈同一性〉であり、分割されることなく、またクローンそのものであることすらない。しかし、まさにこのことによって、それは（哲学それ自体ではなく）非-哲学を**規定**することが可能となる。クローンすること、〈最終-実体化=手続き-規定〉をすること、非-哲学を浮き彫り（bring-forth）にすること——これらの定式はすべて、同一の操作をしており、「産生する（produce）」という言葉よりも、この操作を適切に表現している。
...
6.1.2. 非-哲学的〈主体〉（the non-philosophical Subject）は、哲学的主体とは、その類型（type）からして区別される。それは純粋に超越論的な主体であり、実在の〈自我〉（the real Ego）とは異なり、そこでは〈自我〉が異邦人となるところの〈世界（the World）〉に向かい、また異邦人として〈世界〉に向かう。しかしそれは、最終-実体化=手続き-における-〈自我〉である。〈自我〉と〈主体〉の単面的二元性は、それらの統一的な混同（unitary confusion）に終止符を打つ。この主体は、あたかもすでに構成されたものとして哲学を使用するのではなく、それ自体**が**哲学の使用なのである。それはただ世界-思考（world-thought）を利用するような実践的なものではなく、またそれと等しく理論的でもある。さらに、それは理論を「おこなう（do）」のではなく、それ自体**が**理論なのである。哲学-科学の**クローン**である**超越論的科学**（_transendental science_）は、非-哲学（「思考（の）力（force (of) thought）」）（の）主体そのものである。主体は科学的および哲学的な素材にしたがって変化し、その素材を通して主体は理論的かつ実践的であると言えるが、しかしまた最終-実体化=手続き-実在として、あるいは実在的な自我を超越論的にクローンする〈自我〉として、大域的に超越論的である。

6.1.3. 非-哲学は、主体の最終-実体化=手続き-本質——「思考（の）力」——を構成する超越論的科学であり、それはさらに、「自我-主体-他者（ego-subject-other）」として指し示される特定の素材に基づいて指定される。このようにして、〈主体〉は、それが統合（integrate）する哲学を通した**存在**（_existance_）であり、その脱自的な性質が「存在」としての側面を表している。したがって、〈主体〉の完全な単面的二元性は、一般に「存在する（exist）」と言うことはできず、むしろ思考の別の構造に属する。それは、世界-思考**の**、また世界思考**のための**、理論的・実践的な様態にしたがった、そこに立つこと=援助（_assistance_ [’*adsistence*’]）である。
...
6.1.5. この非-哲学的援助（non-philosophical assistance）とは何を意味するのか？それは、哲学の対象や世界の実体を「変容（transform）」（産出、生成、創造など）することはできない。だがそれは、（対象や実体が、〈一者〉-によって-最終-実体化=手続き-規定-されていることにしたがって、あるいはそれらの相対的な自律性にしたがって生じている根拠、または〈一者のうちでみること〉を通してクローンとして**浮き彫りにされる**根拠であるところの、）同一性と差異の自己現前的な混成である〈全体（a Whole）〉としての哲学を、**変容させる**ことはできる。

それは、哲学がしばしば誤って主張するように、経験の特異性の「内部」に介入するものではなく、またその特異性に意味を与えるものでもない。一般的に言えば、それは主体が外部にとどまるような操作や活動ではない。主体は、その本質（最後の実在としての本質なき本質）において援助なのである。もし援助が解釈でも実践的介入でもないとすれば、それは最後の実在としてのみ実践的である世界思考の生成であり、その存在の生成または与えられることによって、その自律性の様式を変容させ、それを解放し、それによって主体（世界思考の超越論的同一性）が、自らの十分性への幻覚的信念による束縛から解放される。この超越論的同一性は、哲学[la philosophie]そのものが構成するものであり、哲学的な意味での「哲学」[‘la-philosophie’]とは異なり、比較不能なものである。
